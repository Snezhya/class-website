...
export const Absen: React.FC = () => {
  ...
  useGsapScrollReveal(gridRef, '[data-anim-role="scroll-reveal"]', [sorted.length]);
  ...
  return (
    <div className="space-y-6">
      <ScrollReveal>
        <Card motionHoverOnly className="p-6 bg-gradient-to-r from-brand-900/60 to-brand-800/40 border border-brand-800">
