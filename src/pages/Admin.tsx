...
export const Admin: React.FC = () => {
  ...
  const [activeAdminTab, setActiveAdminTab] = useState<'overview' | 'members' | 'customization'>('overview');
    ...
    return (
      <div className="max-w-md mx-auto my-12 space-y-6">
        <div className="text-center space-y-2">
          <div className="w-12 h-12 rounded-xl bg-brand-800 border border-brand-700/80 flex items-center justify-center mx-auto text-terminal-red">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-6">
        ...
        {/* Tab 2: Customization & Background controls */}
        {activeAdminTab === 'customization' && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
